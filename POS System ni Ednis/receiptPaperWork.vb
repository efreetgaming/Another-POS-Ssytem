...
Public Class receiptPaperWork
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_System_ni_Ednis.receiptPaperWork.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreceiptPaperWork
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As receiptPaperWork = New receiptPaperWork()
        rpt.Site = Me.Site
        Return rpt
    End Function
